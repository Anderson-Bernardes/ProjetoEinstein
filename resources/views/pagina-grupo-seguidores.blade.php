                        ...
                        <div class="avatar-feed">
                                        ...
                                        <div class="info-grupo">
                                            <div class="card card-informacoes">
                                                <ul class="nav">
                                                    <li class="nav-item">
                                                      <a class="nav-link" href="{{route('grupos')}}"><p class="text-muted">Publicações 2.364</p>
                                                      </a>
                                                    </li>
                                                    <li class="nav-item">
                                                      <a class="nav-link active" href="#"><p class="text-muted">Seguidores 263 </p></a>
                                                    </li>
                                              ...
                                              <div class="grow">
                                                  <div class="card cardseguidores">
                                                      ...
                                                      <div class="seguir">
                                                          ...
                                                          <a href="#" id="MostrarBotao" style="display:none" class="btn btn-secondary btn-sm btn-custom">x</a>
                                                      </div>
                                                  </div>
                                              </div>
                                              </div>
