...
<div class="container">
                                        ...
                                        <div class="navcard">
                                                <div class="card">
                                                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical" >
                                                            <a class="nav-link active"  id="v-pills-feed-tab" data-toggle="pill" href="#v-pills-feed" role="tab" aria-controls="v-pills-feed" aria-selected="true"><i class="fas fa-rss-square mx-2"></i> Feed</a>
                                                            <a class="nav-link" id="v-pills-pagina-tab" data-toggle="pill" href="#v-pills-pagina" role="tab" aria-controls="v-pills-pagina" aria-selected="false"><i class="fa fa-flag mx-2"></i>Páginas</a>
                                                            <a class="nav-link" id="v-pills-material-tab" data-toggle="pill" href="#v-pills-material" role="tab" aria-controls="v-pills-material" aria-selected="false"><i class="fa fa-graduation-cap mx-2"></i>Material</a>
                                                            <a class="nav-link" id="v-pills-amigos-tab" data-toggle="pill" href="#v-pills-amigos" role="tab" aria-controls="v-pills-amigos" aria-selected="false"><i class="fa fa-users mx-2"></i>Amigos</a>
                                                            <a class="nav-link" id="v-pills-recomendacoes-tab" data-toggle="pill" href="#v-pills-recomendacoes" role="tab" aria-controls="v-pills-recomendacoes" aria-selected="false"><i class="fas fa-book-reader mx-2"></i>Recomendações</a>
                                                            <a class="nav-link" id="v-pills-emblemas-tab" data-toggle="pill" href="#v-pills-emblemas" role="tab" aria-controls="v-pills-emblemas" aria-selected="false"><i class="fas fa-crown mx-2"></i>Emblemas</a>
                                                          </div>
                                                    </div>
                        ...
                        <div class="col-9">
                          <div class="tab-content" id="v-pills-tabContent">
                                                ...
                                                <div class="card gedf-card " >
                                                        <div class="card-header">
                                                            <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                                                                <li class="nav-item">
                                                                    <a class="nav-link active" id="posts-tab" data-toggle="tab" href="#posts" role="tab" aria-controls="posts" aria-selected="true">Dúvida</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" id="images-tab" data-toggle="tab" role="tab" aria-controls="images" aria-selected="false" href="#images">Vídeo Aula</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" id="images-tab" data-toggle="tab" role="tab" aria-controls="images" aria-selected="false" href="#outros">Outros</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="card-body">
                                                                ...
                                                                <div class="tab-pane fade" id="images" role="tabpanel" aria-labelledby="images-tab">
                                                                    <div class="form-group">
                                                                        <div class="custom-file">
                                                                            ...
                                                                            <label class="custom-file-label" for="customFile">Upload do Vídeo</label>
                                                            ...
                                                            <div class="btn-toolbar justify-content-between">
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu mt-2 dropdown-menu-right" aria-labelledby="btnGroupDrop1">
                                                        ...
                                                        <div class="card">
                                                          ...
                                                          <div class="usuarios-no-topo">
                                                            ...
                                                            <div class="foto-raking col-3">
                                                                <img src="https://scontent.fpoo3-1.fna.fbcdn.net/v/t1.0-9/28471636_1667459376624284_4323301383653421700_n.jpg?_nc_cat=109&_nc_ht=scontent.fpoo3-1.fna&oh=8c0e4e659476432a613894914549e816&oe=5D2E44CE" alt="Avatar">
                                                            </div>
                                                            ...
                                                            <div class="pontos col-4">
                                                              ...
                                                              <div class="row">
                                                            <div class="foto-raking col-3">
                                                                <img src="https://scontent.fpoo3-1.fna.fbcdn.net/v/t1.0-9/56196650_2113555888735986_4353139037431660544_n.jpg?_nc_cat=102&_nc_ht=scontent.fpoo3-1.fna&oh=6e97953cb2d20a53b6eb0f36dec832a7&oe=5D5D7C69" alt="Avatar">
                                                            </div>
                                                            <div class="nome-raking col-5">
                                                              <a href="#">Marinhou</a>
                                                            </div>
                                                            <div class="pontos col-4">
                                                              ...
                                                              <div class="row">
                                                            <div class="foto-raking col-3">
                                                                <img src="https://scontent.fpoo3-1.fna.fbcdn.net/v/t1.0-9/26731694_1773729232698306_2779420609315737612_n.jpg?_nc_cat=101&_nc_ht=scontent.fpoo3-1.fna&oh=d63828518cffdf5fd1c49bf8dae06d34&oe=5D759600" alt="Avatar">
                                                            </div>
                                                            <div class="nome-raking col-5">
                                                              <a href="#">Marcel23</a>
                                                            </div>
                            ...
                            <div class="tab-pane fade" id="v-pills-material" role="tabpanel" aria-labelledby="v-pills-material-tab">material</div>
                            <div class="tab-pane fade" id="v-pills-amigos" role="tabpanel" aria-labelledby="v-pills-amigos-tab">amigos</div>
                            <div class="tab-pane fade" id="v-pills-recomendacoes" role="tabpanel" aria-labelledby="v-pills-recomendacoes-tab">recomendações</div>
