    ...
    <div class="row">
        <div class="col-3">
            ...
            <div class="card cardinfo">
                <div class="info">
                    ...
                    <input class="form-control form-control mt-2" type="text" placeholder="Nome" value="{{$user->name}}">
                    <input class="form-control form-control mt-2" type="text" placeholder="@Apelido" value="{{$user->username}}">
                   {{-- <select class="custom-select mt-2" id="inlineFormCustomSelectPref">
                    ...
                    <div class="botao">
                        <button type="button" class="btn btn-default mt-4">Salvar</button>
                    </div>
        ...
        <div class="col-9">
                    ...
                    <fieldset disabled>
                        <div class="form-group">
                            ...
                            <input type="text" id="disabledTextInput" class="form-control"
                                   placeholder="Celysastre@hotmail.com" value="{{$user->email}}">
                        </div>
                    </fieldset>
                    <div class="form-group">
            ...
            <div class="card excluirperfil">
                ...
                <div class="botao">
                    <button type="button" class="btn btn-default mt-4 mb-4">Salvar</button>
                </div>
            </div>
        </div>
    </div>
